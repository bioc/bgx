...
library(hgu95av2cdf)
data(Dilution)
eset <- bgx(Dilution, samplesets=c(2,2), probeAff=FALSE, burnin=2048, iter=8192,genes=c(12500:12599), output="all", basepath=".")
@
...
In order to view a plot of ranked differential expression values and save these in a matrix, you could do:

<<fig=TRUE>>=
rankedGeneList <- plotDERank(bgxOutput)
@
